...
[@bogard namespace](https://www.npmjs.com/org/cosmjs), a so called monorepo.
Here are some of them to get an idea:

| Package                                                 | Description                                                                                                                                                                                                                              | Latest                                                                                                                                |
| ------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| [@bogard/stargate](packages/stargate)                   | A client library for the Cosmos SDK 0.40+ (Stargate)                                                                                                                                                                                     | [![npm version](https://img.shields.io/npm/v/@bogard/stargate.svg)](https://www.npmjs.com/package/@bogard/stargate)                   |
| [@bogard/faucet](packages/faucet)                       | A faucet application for node.js                                                                                                                                                                                                         | [![npm version](https://img.shields.io/npm/v/@bogard/faucet.svg)](https://www.npmjs.com/package/@bogard/faucet)                       |
| [@bogard/cosmwasm-stargate](packages/cosmwasm-stargate) | Client for Stargate chains with the CosmWasm module enabled                                                                                                                                                                              | [![npm version](https://img.shields.io/npm/v/@bogard/cosmwasm-stargate.svg)](https://www.npmjs.com/package/@bogard/cosmwasm-stargate) |
| [@bogard/crypto](packages/crypto)                       | Cryptography for blockchain projects, e.g. hashing (SHA-2, Keccak256, Ripemd160), signing (secp256k1, ed25519), HD key derivation (BIP-39, SLIP-0010), KDFs and symmetric encryption for key storage (PBKDF2, Argon2, XChaCha20Poly1305) | [![npm version](https://img.shields.io/npm/v/@bogard/crypto.svg)](https://www.npmjs.com/package/@bogard/crypto)                       |
| [@bogard/encoding](packages/encoding)                   | Encoding helpers for blockchain projects                                                                                                                                                                                                 | [![npm version](https://img.shields.io/npm/v/@bogard/encoding.svg)](https://www.npmjs.com/package/@bogard/encoding)                   |
| [@bogard/math](packages/math)                           | Safe integers; decimals for handling financial amounts                                                                                                                                                                                   | [![npm version](https://img.shields.io/npm/v/@bogard/math.svg)](https://www.npmjs.com/package/@bogard/math)                           |
...
from_npm . | depsight --include "^@bogard" --format png --dpi 150 --output docs/cosmjs-tree.png
